...
from ai_data_dashboard.models.result.schema import ResultCreate, ResultUpdate
from ai_data_dashboard.repositories.base import AsyncSession, BaseRepository, NotFoundError
