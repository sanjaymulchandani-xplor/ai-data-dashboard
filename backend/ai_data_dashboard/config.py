...
from ai_data_dashboard.utils.appdirs import user_data_dir
...
USER_DATA_DIR = user_data_dir(appname="AI Data Dashboard")
...
class Config(BaseSettings):
    ...
    # This is where all AI Data Dashboard data is stored
