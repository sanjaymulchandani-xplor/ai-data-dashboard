...
from ai_data_dashboard.models.llm_flow.schema import SQLQueryRunResult
from ai_data_dashboard.models.message.schema import MessageOptions, MessageWithResultsOut
from ai_data_dashboard.models.result.schema import ResultOut
from ai_data_dashboard.old_models import SuccessListResponse, SuccessResponse
from ai_data_dashboard.repositories.base import AsyncSession, get_session
from ai_data_dashboard.services.connection import ConnectionService
from ai_data_dashboard.services.conversation import ConversationService
from ai_data_dashboard.services.llm_flow.toolkit import execute_sql_query
from ai_data_dashboard.services.llm_flow.utils import AppSQLDatabase as SQLDatabase
from ai_data_dashboard.utils.posthog import posthog_capture
from ai_data_dashboard.utils.utils import generate_with_errors
...
async def execute_sql(
    ...
    # Refresh chart data
    db = SQLDatabase.from_app_connection(connection)
