...
from ai_data_dashboard.models.message.schema import MessageOut, MessageWithResultsOut
...
from ai_data_dashboard.old_models import ConversationWithMessagesWithResults

if TYPE_CHECKING:
    from ai_data_dashboard.models.conversation.model import ConversationModel
