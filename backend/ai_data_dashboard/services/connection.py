...
from ai_data_dashboard.models.connection.schema import (
...
from ai_data_dashboard.repositories.base import AsyncSession, NotFoundError, NotUniqueError
from ai_data_dashboard.repositories.connection import (
    ConnectionCreate,
    ConnectionRepository,
    ConnectionType,
    ConnectionUpdate,
)
from ai_data_dashboard.services.file_parsers.excel_parser import ExcelParserService
from ai_data_dashboard.services.llm_flow.utils import AppSQLDatabase as SQLDatabase
from ai_data_dashboard.utils.utils import (
...
class ConnectionService:
    ...
    async def refresh_connection_schema(self, session: AsyncSession, connection_id: UUID) -> ConnectionOut:
        ...
        1. Get the latest schema information from the database (using AppSQLDatabase)
