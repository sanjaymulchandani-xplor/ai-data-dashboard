...
from ai_data_dashboard.errors import ValidationError
from ai_data_dashboard.models.connection.schema import Connection
from ai_data_dashboard.models.llm_flow.enums import QueryResultType
from ai_data_dashboard.models.llm_flow.schema import ChartGenerationResultContent, SQLQueryStringResultContent
from ai_data_dashboard.models.result.schema import ChartRefreshOut, ResultUpdate
from ai_data_dashboard.repositories.base import AsyncSession, NotFoundError
from ai_data_dashboard.repositories.result import ResultRepository
from ai_data_dashboard.services.llm_flow.llm_calls.chart_generator import ChartType
from ai_data_dashboard.services.llm_flow.toolkit import RunException, execute_sql_query, query_run_result_to_chart_json
...
class ResultService:
    ...
    async def refresh_chart_result_data(self, session: AsyncSession, chart_id: UUID) -> ChartRefreshOut:
        ...
        db = SQLDatabase.from_app_connection(Connection.model_validate(connection))
