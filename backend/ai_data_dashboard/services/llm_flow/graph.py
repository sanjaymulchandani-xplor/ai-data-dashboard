...
from ai_data_dashboard.models.llm_flow.schema import QueryOptions, ResultType
from ai_data_dashboard.services.llm_flow.nodes import (
    CallModelNode,
    CallToolNode,
    Condition,
    Node,
...
from ai_data_dashboard.services.llm_flow.prompt import SQL_FUNCTIONS_SUFFIX, SQL_PREFIX
from ai_data_dashboard.services.llm_flow.toolkit import (
    ChartGeneratorTool,
    QueryGraphState,
    SQLDatabaseToolkit,
)
from ai_data_dashboard.services.llm_flow.utils import ConnectionProtocol, AppSQLDatabase as SQLDatabase
from ai_data_dashboard.utils.utils import forward_connection_errors
...
class QueryGraphService:
    def __init__(self, connection: ConnectionProtocol) -> None:
        ...
        try:
            self.db = SQLDatabase.from_app_connection(connection)
