...
You only need an OpenAI API key to start using this app. You may optionally use Langsmith to record logs for your LLM flow.
...
uv run uvicorn ai_data_dashboard.main:app --reload --port=7377
```
